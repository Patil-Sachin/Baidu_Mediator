...
s.author       = "Team"
s.platform     = :ios, "8.0"
s.source       = {:git => 'https://bitbucket.org/vdopia/sdkdistribution.git',:tag => '3.1.1'}
...
s.vendored_libraries = "libVdopiaBaiduMediator.a"
s.vendored_frameworks = "DUModuleSDK.framework"
